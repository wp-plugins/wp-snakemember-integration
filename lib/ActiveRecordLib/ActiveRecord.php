...
if (!defined('PHP_ACTIVERECORD_AUTOLOAD_DISABLE'))
	spl_autoload_register('wp_activerecord_autoload',false,PHP_ACTIVERECORD_AUTOLOAD_PREPEND);
...
/*
 * Michele : Autoloads activerecord default plus all other plugins' models!! 
 * 
 */
function wp_activerecord_autoload($class_name)
{
